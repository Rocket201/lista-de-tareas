/*document.addEventListener -> es una función de JavaScript que se utiliza para escuchar eventos en una página web. 
En otras palabras, te permite decirle al navegador que esté atento a algo específico que pueda ocurrir en la página y 
que ejecute cierto código cuando ese evento suceda.*/

/*DOMContentLoaded: Es una forma de garantizar que tu código JavaScript se ejecute solo después de que la página web haya terminado de cargarse, 
evitando problemas de interacción con elementos que aún no han aparecido en la pantalla.*/
